<?php namespace meSmart\kit\admin;
/**
 ...
 * @package       Extend.Admin.ContentExtendAction
 * @since         Smart ThinkPHP Extend 2.0.0
...
class ContentController extends Controller {
	...
	public function add() {
		...
		Redirect::success('创建成功，请编辑', U('edit', array('id' => $id)));
	}
	...
	public function image() {
		...
		$info = Library\Upload::image($_FILES['uploadify_file'], $image_thumb_name);
	...
	public function cover() {
		...
		// 上传图片
		$info = Library\Upload::image($_FILES['uploadify_file'], $this->cover_thumb_name);
	...
	protected function category() {
		...
		$Category = new Library\Category($this->category_model);
